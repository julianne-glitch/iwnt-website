                  ...
                  <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
                    ...
                    <div className="flex items-center gap-2.5">
                      <div className="flex items-center gap-1.5 rounded-full bg-emerald-50 px-2.5 py-0.5 border border-emerald-100">
                        ...
                        <span className="text-[10px] font-bold text-[#16A34A]">Live Workspace</span>
                      </div>
                    ...
                    <div className="col-span-9 space-y-3">
                      ...
                      <div className="grid grid-cols-4 gap-2">
                        <div className="rounded-xl border border-slate-100 bg-[#F8FAFC] p-2">
                          <div className="text-[9.5px] font-bold text-slate-500">Total Employees</div>
                        ...
                        <div className="rounded-xl border border-slate-100 bg-[#F8FAFC] p-2">
                          <div className="text-[9.5px] font-bold text-slate-500">Active Countries</div>
                        ...
                        <div className="rounded-xl border border-slate-100 bg-[#F8FAFC] p-2">
                          <div className="text-[9.5px] font-bold text-slate-500">Payroll Processed</div>
                          <div className="text-base font-extrabold text-[#0D1B2E]">$4.3M</div>
                          <div className="text-[9px] font-bold text-emerald-600">+12.5%</div>
                        </div>

                        <div className="rounded-xl border border-slate-100 bg-[#F8FAFC] p-2">
                          <div className="text-[9.5px] font-bold text-slate-500">Compliance Rate</div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <div className="rounded-xl border border-slate-100 p-2.5 bg-white space-y-1.5">
                          <div className="flex items-center justify-between">
                            <span className="text-[10.5px] font-bold text-[#0D1B2E]">Workforce by Country</span>
                        ...
                        {/* RECENT ACTIVITY */}
                        <div className="rounded-xl border border-slate-100 p-2.5 bg-white space-y-1.5">
                          <div className="text-[10.5px] font-bold text-[#0D1B2E]">Recent Activity</div>
          ...
          <div className="grid grid-cols-12 gap-5 items-center my-2 relative min-h-[290px]">
            ...
            <div className="col-span-3 shrink-0 space-y-2.5 flex flex-col justify-center">
              ...
              >
                ...
                <p className="text-xs sm:text-[13px] font-bold text-[#0D1B2E] leading-snug">
                  {p.block2ClientMsg}
                </p>
              </motion.div>
